...
const MultipleFormattersDefinedFor_1 = __nccwpck_require__(4838);
const NoFormatterDefinedFor_1 = __nccwpck_require__(7894);
/**
...
const marked_1 = __nccwpck_require__(4223);
const he_1 = __nccwpck_require__(3527);
class Plaintext extends marked_1.Renderer {
    code(code, language, isEscaped) {
        return (0, he_1.decode)(code);
    }
    blockquote(quote) {
        return (0, he_1.decode)(quote);
    }
    html(html) {
        return (0, he_1.decode)(html);
    }
    heading(text, level, raw, slugger) {
        return (0, he_1.decode)(text) + ':\n';
    }
    hr() {
        return '';
    }
    list(body, ordered, start) {
        return (0, he_1.decode)(body) + '\n';
    }
    ...
    link(href, title, text) {
        return (0, he_1.decode)(text) + ' (' + href + ')';
    }
...
const marked_1 = __nccwpck_require__(4223);
const InvalidChangelogURL_1 = __nccwpck_require__(4698);
const VersionNotProvided_1 = __nccwpck_require__(7076);
/**
...
class ReleaseParser {
    ...
    parse(version, body, changelogURL) {
        ...
        return Object.assign({ version, body: tokens }, changelog);
    }
...
const MarkdownRenderer_1 = __nccwpck_require__(7692);
const MSbuildOutputFormatter_1 = __nccwpck_require__(7829);
const OutputFormatters_1 = __nccwpck_require__(8083);
const PlaintextRenderer_1 = __nccwpck_require__(718);
const RawOutputFormatter_1 = __nccwpck_require__(4444);
const ReleaseNotesCreator_1 = __nccwpck_require__(99);
const ReleaseParser_1 = __nccwpck_require__(9992);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const changelogURL = (0, core_1.getInput)('changelog-url');
            let outputFormat = (0, core_1.getInput)('output-format');
            logger.info('Inputs:');
...
function output(markdown, plaintext) {
    ...
    (0, core_1.setOutput)('markdown', markdown);
    (0, core_1.setOutput)('plaintext', plaintext);
}
function fail(error) {
