...
export const a_release_version = '1.0.0';

export const a_release_summary = `
## Summary
...
export const a_release_changelog_url = 'https://github.com/dolittle/create-release-notes-action/blob/master/CHANGELOG.md';
